        ...
        <div className="mt-6 bg-gray-50 p-4 rounded-md">
          ...
          <div className="space-y-2">
            <div>
              ...
              <p className="text-sm text-gray-500">Email: admin@demo.com</p>
            ...
            <div>
              ...
              <p className="text-sm text-gray-500">Email: teacher@demo.com</p>
              <p className="text-sm text-gray-500">Password: teacher123</p>
            </div>
          </div>
        </div>
      </div>
